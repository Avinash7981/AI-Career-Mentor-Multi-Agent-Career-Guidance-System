...
class Gemini extends import_base_llm.BaseLlm {
  ...
  async *generateContentAsync(llmRequest, stream = false, abortSignal) {
    ...
    import_logger.logger.info(
      `Sending out request, model: ${(_a = llmRequest.model) != null ? _a : this.model}, backend: ${this.apiBackend}, stream: ${stream}`
    );
